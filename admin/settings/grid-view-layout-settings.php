...
class People_Contact_Grid_View_Layout_Settings extends People_Contact_Admin_UI
{
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( 'Profile Card background Hover Colour', 'cup_cp' ),
				'desc' 		=> __( "Just apply for Card set to show Location on Map.", 'cup_cp'),
			...
			array(
            	'name' 		=> __( 'Profile Card Fonts', 'cup_cp' ),
                'type' 		=> 'heading',
